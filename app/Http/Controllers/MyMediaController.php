...
class MyMediaController extends Controller
{
    ...
    public function mymedia()
    {
        ...
        $data['News']  = News::with('category')->with('rating')->withCount('comments')->where('select',1)->latest()->take(3)->get();
        $data['Articles']  = Article::where('select',1)->latest()->take(6)->get();
        $data['Stories']  = Storie::where('select',1)->latest()->take(6)->get();
        $data['Courses']  = Course::where('select',1)->latest()->take(3)->get();
        $data['opportunities']  = Opportunity::where('select',1)->latest()->take(4)->get();


        return view('frontend.mymedia', $data);
    }
