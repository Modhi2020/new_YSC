...
class CreateRadioQuestionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('radio_questions', function (Blueprint $table) {
            $table->id();
            $table->text('questions');
            $table->string('type')->default('radio_questions');
    ...
    {
        Schema::dropIfExists('radio_questions');
    }
}
